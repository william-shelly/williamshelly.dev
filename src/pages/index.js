...
const IndexPage = () => {
  ...
  const photoLink =
    "https://unsplash.com/photos/4hbJ-eymZ1o?utm_source=unsplash&utm_medium=referral&utm_content=creditShareLink";
    ...
    <Homepage>
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <div className="photo-credit background-color-primary p-3">
            ...
            >
              Thank you <strong>{photoCredit}</strong>! For such a wonderful
              photo!
            </a>
          </div>
        </div>
      ...
      <div className="jumbotron text-center bg-white">
        <h2 className="fs-4 my-4 text-center color-primary">
          Do you need help with Design Work
          <br />
          or a Developer to Code your Site?
        </h2>
        <p className="text-base my-4 text-center">
          Let's discuss your project and how I can help you meet your goals.
        </p>
        <Link
          className="btn btn-primary d-sm-inline-block m-0-auto align-center mr-2"
          to="/contact"
        >
          Let's Talk!
        </Link>
